...
/**
 * @author JZKJ-LWC
 * @date : 2015-12-11 下午1:28:22 我的二维码页面
 */
...
public class TwoDimensionCodeActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 构造需要插入的图片对象
		mBitmap = ((BitmapDrawable) getResources().getDrawable(R.drawable.logo))
				.getBitmap();
		// 缩放图片
		Matrix m = new Matrix();
...
//			}
		...
		mhome.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				TwoDimensionCodeActivity.this.finish();
				startActivity(new Intent(TwoDimensionCodeActivity.this,
						MainActivity.class));
			}
		});
