...
public class oederactivity1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(isconnection){
			...
			Toast.makeText(oederactivity1.this,"请检查网络设置",1).show();
		}
	...
	private void initmanager() {
		// TODO Auto-generated method stub
		manager =(ConnectivityManager) oederactivity1.this.getSystemService(oederactivity1.this.CONNECTIVITY_SERVICE);//获得网络连接的管理者对象
		isconnection=InternerIsConnection.network(manager,oederactivity1.this);
	}
