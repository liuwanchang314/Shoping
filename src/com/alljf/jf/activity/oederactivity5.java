...
public class oederactivity5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(isconnection){
			...
			Toast.makeText(oederactivity5.this,"请检查网络设置",1).show();
		}
	}
	/**
	 * @author JZKJ-LWC
	...
	private void initmanager() {
		// TODO Auto-generated method stub
		manager =(ConnectivityManager) oederactivity5.this.getSystemService(oederactivity5.this.CONNECTIVITY_SERVICE);//获得网络连接的管理者对象
		isconnection=InternerIsConnection.network(manager,oederactivity5.this);
	}
				...
				http.send(HttpRequest.HttpMethod.POST,"http://www.91jf.com/api.php",params,new RequestCallBack<String>() {
				        ...
				        public void onSuccess(ResponseInfo<String> responseInfo) {
				        	...
				        	for(int i=0;i<count;i++){
				        		if(list.get(i).getOrder_status().equals("40")){
				        			//说明是代付款
				        	...
				        	tv.setOnClickListener(new OnClickListener() {
								...
								public void onClick(View v) {
									// TODO Auto-generated method stub
									Intent intent=new Intent(oederactivity5.this,AllProductActivity.class);
				        	...
				        	mListview.setOnItemClickListener(new OnItemClickListener() {
								...
								public void onItemClick(AdapterView<?> arg0,
									...
									// TODO Auto-generated method stub
									Intent intent=new Intent(oederactivity5.this,DingDanXQActivity.class);
	...
	private void initview() {
		...
		mdialog=new SpotsDialog(oederactivity5.this);
		mdialog.setCanceledOnTouchOutside(false);
		mListview=(ListView) findViewById(R.id.order_daipingjia);
	}
}
