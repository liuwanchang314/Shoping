...
public class oederactivity3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(isconnection){
			...
			Toast.makeText(oederactivity3.this,"请检查网络设置",1).show();
		}
	}
	/**
	 * @author JZKJ-LWC
	...
	private void initmanager() {
		// TODO Auto-generated method stub
		manager =(ConnectivityManager) oederactivity3.this.getSystemService(oederactivity3.this.CONNECTIVITY_SERVICE);//获得网络连接的管理者对象
		isconnection=InternerIsConnection.network(manager,oederactivity3.this);
	}
	/**
	 * @author JZKJ-LWC
	...
	private void initview() {
		...
		mdialog=new SpotsDialog(oederactivity3.this);
