...
public class AutoScrollViewPager extends ViewPager {
    ...
    private NotifyPageChanged mChangeListener;
    ...
    public void setPageChangeListener(NotifyPageChanged  listener){
    ...
    public void scrollOnce() {
        ...
        if (nextItem < 0) {
        	...
        	//Log.d("luke", "nextItem="+nextItem);
//        	mChangeListener.notifyChange(nextItem);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
       ...
       /* if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || slideBorderMode == SLIDE_BORDER_MODE_CYCLE) {
            ...
            int currentItem = getCurrentItem();
//            PagerAdapter adapter = getAdapter();
//            int pageCount = adapter == null ? 0 : adapter.getCount() -1;
            ...
            *//**
             ...
             * one.
             *//*
            currentItem = currentItem % (pagecount);
            Log.d("luke", "currentItem="+currentItem);
            
            if ((currentItem == 0 && downX <= touchX) || (currentItem == pagecount - 1 && downX >= touchX)) {
                if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT) {
                    getParent().requestDisallowInterceptTouchEvent(false);
                } else {
                	mChangeListener.notifyChange(currentItem);
                    getParent().requestDisallowInterceptTouchEvent(true);
                    
                    if (pagecount > 1) {
                    	  Log.d("luke", "currentItem2="+currentItem);
